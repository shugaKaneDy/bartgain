...
$dateCondition = "WHERE payments.payment_type = 'premium' 
...
$premiums = selectQuery($pdo, $sql, $params);

$totalPremiumAmount = 0;

foreach ($premiums as $premium) {
  $totalPremiumAmount += $premium['payment_amount'];
}

// Total count after applying filters
$totalPremium = count($premiums);
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-success elevation-1"><i class="fas fa-gem"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Total Premium Availed</span>
                <span class="info-box-number"><?= $totalPremium ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total Premium Sale</span>
                <span class="info-box-number font-weight-bold text-success">₱ <?= $totalPremiumAmount ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <form method="GET" class="mb-3">
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <a href="sale-premium.php" class="btn btn-secondary" style="margin-top: 30px;">Reset</a>
            </div>
          </div>
        </form>
                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php foreach($premiums as $premium): ?>
                      <tr>
                        <td><?= $premium['fullname'] ?></td>
                        <td><?= $premium['payment_num'] ?> Months</td>
                        <td class="text-success font-weight-bold">₱ <?= number_format($premium['payment_amount'],2) ?></td>
                        <td>
                          <?php if($premium['payment_paid_type'] == 'gcash'): ?>
                            <span class="badge badge-primary">
                              <?= $premium['payment_paid_type'] ?>
                            </span>
                          <?php else: ?>
                        ...
                        <td><?= date("M d, Y", strtotime($premium['payment_created_at'])) ?></td>
                      </tr>
                    <?php endforeach ?>
                  </tbody>
                </table>
