  ...
  $(document).ready(function() {
    ...
    <?php if($reportUserInfo['report_status'] == "pending"): ?>
      ...
      $('#resolveBtn').on('click', function(e) {
          ...
          let formData = $('#resolveForm').serializeArray();
          ...
          Swal.fire({
            ...
            if(result.isConfirmed) {
              $.ajax({
                method: 'POST',
                url: "includes/ajax/report-user-resolve.inc.php",
                data: formData,
                dataType: "JSON",
              }).done(function (res) {
      ...
      $('#dismissBtn').on('click', function(e) {
        ...
        Swal.fire({
          title: 'Are you sure?',
          text: "Do you want to dismiss this report?",
          icon: 'warning',
          showCancelButton: true,
          confirmButtonText: 'Yes',
          cancelButtonText: 'No'
          ...
          if(result.isConfirmed) {
            $.ajax({
              method: 'POST',
              url: "includes/ajax/report-user-dismiss.inc.php",
              data: {
                ru_id: <?= json_encode($ru_id) ?>
              },
              dataType: "JSON",
            }).done(function (res) {
