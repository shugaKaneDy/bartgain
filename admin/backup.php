...
function backup_tables($host, $user, $pass, $dbname, $tables = '*') {
    ...
    // Save file to server
    $fileName = 'db-backup-' . date('Y-m-d-His') . '-bartgain.sql';
    ...
    // Redirect to backup-database.php
    echo "<script>setTimeout(function() { window.location.href = 'backup-database.php'; }, 100);</script>";
    exit;
}
