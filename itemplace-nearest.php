      ...
      <div class="offcanvas-body">
        ...
        <div class="mb-3">
          ...
          <div>
            ...
            <a href="#" class="btn btn-sm btn-success mb-2 me-1 rounded-pill">
              Nearest
            </a>
          </div>
        </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      function itemBoosted() {
        $.ajax({
          method: 'GET',
          url: "includes/ajax/item-boosted-filters.php?function=nearest",
        }).done(res => {
          boosted.html(res);
        })
      }
      ...
      function itemNotBoosted(page) {
          $.ajax({
              method: 'GET',
              url: "includes/ajax/item-not-boosted-filters.php?function=nearest",
              data: { 
                page: page
              }
          }).done(res => {
