<?php
  ...
  $_SESSION['csrf_token_change_pass'] = $csrfToken;
    ...
    <div class="card border-0">
      <div class="card-body">
        ...
        <form id="forgotForm" class="mb-3">
          ...
          <div class="mb-3">
            <input id="password" name="password" type="password" class="form-control my-input" placeholder="Enter Your Password">
          </div>
          <div class="mb-3">
            <input id="cpassword" name="cpassword" type="password" class="form-control my-input" placeholder="Confirm">
          </div>
          <div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $(document).on("click", '#submitBtn', function() {
        ...
        $.ajax({
          url: "includes/ajax/authentication.php?function=forgot-change-password",
          method: "POST",
          data: formData,
          dataType: "json",
          beforeSend: function () {
