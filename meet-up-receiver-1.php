...
<body class="bg-light">
  ...
  <main>
    <div class="container-xl">
      ...
      <?php if($offerPartner['meet_up_status'] == 'completed'): ?>
  ...
  <script>
    $(document).ready(function() {
      ...
      function meetupLocationDirection() {
        ...
        var partnerLng = <?= json_encode($offerPartner['lng']) ?>;
        var partnerLat = <?= json_encode($offerPartner['lat']) ?>;
        ...
        if (partnerRoutingControl) {
            map.removeControl(partnerRoutingControl); // Remove previous route from the map
        }
