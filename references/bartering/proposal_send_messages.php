...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result) {
        $insertQuery = "INSERT INTO messages (offer_id, sender_user_id, receiver_user_id, sender_message, message_created_at) 
                        VALUES (:offer_id, :sender_user_id, :receiver_user_id, :sender_message, :messageCreated)";
        ...
        $insertStmt->bindParam(':sender_message', $senderMessage, PDO::PARAM_STR);
