...
<body class="bg-light">
  ...
  <div class="container mb-5">
    <!-- Your main content goes here -->
     ...
     <div>
      <nav class="nav">
        <a class="nav-link text-sm" href="offers.php">Pending Offers</a>
        <a class="nav-link text-primary text-sm" href="offers-history.php">Offers History</a>
      </nav>
    </div>
     <div class="table-responsive border p-4 border shadow rounded">
      <table id="myTable" class="table table-striped">
        <thead>
          <th>Offers History</th>
        </thead>
        <tbody>
          <?php
