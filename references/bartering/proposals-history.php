...
<body class="bg-light">
  ...
  <div class="container mb-5">
    <!-- Your main content goes here -->
     ...
     <div>
      <nav class="nav">
        <a class="nav-link text-sm" href="proposals.php">Pending Proposals</a>
        <a class="nav-link text-primary text-sm" href="proposals-history.php">Proposals History</a>
      </nav>
    </div>
     <div class="table-responsive border p-4 border shadow rounded">
      <table id="myTable" class="table table-striped">
        <thead>
          <th>Proposals History</th>
        </thead>
        <tbody>
          <?php
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-md-6 mb-3">
                        <div class="d-flex gap-3">
                          ...
                          <div class="d-flex flex-column justify-content-end align-items-start">
                            <p class="text-center m-0 text-sm">Your Offer</p>
                            ...
                            <div>
                              ...
                              <a href="messages-proposals.php?offerId=<?= $row->offer_id ?>" class="btn btn-light border btn-sm">View Messages</a>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 mb-3">
                        <div class="d-flex gap-3">
                          ...
                          <div class="d-flex flex-column justify-content-end align-items-start">
                            <p class="text-center m-0 text-sm">Item</p>
