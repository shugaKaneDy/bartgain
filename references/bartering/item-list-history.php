...
<body class="bg-light">
  ...
  <div class="container mb-5">
    <h3>Item List History</h3>
    <div>
      <nav class="nav">
        <a class="nav-link text-sm" href="item-listing.php">Item Listing</a>
        <a class="nav-link text-primary text-sm" href="item-list-history.php">Item List History</a>
      ...
      <tbody>
        <?php
          $query = "SELECT * FROM items 
                    ...
                    WHERE items.item_user_id = $userId
