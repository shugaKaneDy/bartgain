<?php
  ...
  $_SESSION['csrf_token_in'] = $csrfToken;
?>
    ...
    <div class="row g-0 rounded bg-light shadow-sm">
      ...
      <div class="col-12 col-md-6 p-3 pb-5 p-md-5">
        <div class="d-flex d-md-none gap-2 mt-3 mb-5 justify-content-center">
          <img src="assets/logo.png" class="my-logo" alt="">
        ...
        <form id="signInForm">
          ...
          <div class="form-floating mb-3">
            <input name="email" type="email" class="form-control my-input" id="email" placeholder="name@example.com">
          ...
          <div class="d-flex justify-content-end">
            <a href="forgot-password.php" class="link link-success small-text">forgot password?</a>
          </div>
          <input type="hidden" class="location" id="location" name="location"/>
          <button id="btnSignIn" class="btn btn-success mb-5 rounded-5 px-5">Sign in</button>
        </form>
        <a class="d-md-none text-decoration-none text-dark pb-5" href="signup.php">Not a member of BartGain? <span class="fw-bold text-success text-nowrap"> Sign up</span></a>
      </div>
        ...
        navigator.geolocation.getCurrentPosition(function(position) {
          ...
          $.ajax({
            ...
            success: function(res) {
              ...
              $('#location').val(res.city + ', ' + res.localityInfo.administrative[2].name);
              ...
              $.ajax({
                ...
                method: 'POST',
                url: "includes/ajax/authentication.php?function=signin",
                data: formData,
                dataType: "JSON",
                beforeSend: function () {
