          ...
          <div class="px-3 py-4 bg-white rounded border shadow-sm">
            <ul class="nav nav-pills" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Offers</button>
              </li>
              <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <table id="table1" class="table table-hover table-striped">
                  ...
                  <tbody>
                    <?php foreach($offers as $offer): ?>
                      <?php
                        $itemUrlFiles = explode(',' , $offer['item_url_file']);
                        $itemFirstFile = $itemUrlFiles[0];
                        $itemExt = explode('.', $itemFirstFile);
                        $itemExt = end($itemExt);

                        $offerUrlFiles = explode(',' , $offer['offer_url_file']);
                        ...
                        <td>
                          <div class="row">
                            <div class="col-12 col-md-6 mb-3">
                              <p class="small-text mb-1 badge text-bg-success">Your Item</p>
                              <div class="d-flex gap-3">
                                ...
                                <div>
                                  ...
                                  <p class="m-0 small-text text-muted">
                                    Status:
                                    <?php if($offer['item_status'] == 'available'): ?>
                                  ...
                                  <p class="smaller-text text-muted">
                                    <?= date("M d, Y", strtotime($offer['item_created_at'])) ?>
                                  </p>
                                  <div>
                                    <button class="btn btn-sm btn-light border me-1 mb-2 forPopup w-100"
                                    value="<?= $offer['item_random_id'] ?>"
                            ...
                            <div class="col-12 col-md-6 mb-3">
                              <p class="small-text m-0">Partner Offer</p>
                              <div class="d-flex gap-3">
                                <div>
                                ...
                                <div>
                                  ...
                                  <p class="m-0 small-text text-muted">
                                    Status:
                                    <?php if($offer['offer_status'] == 'available'): ?>
                                      <span class="text-success">
                                        <?= $offer['offer_status'] ?>
                                      </span>
                                    <?php else: ?>
                          ...
                          <div class="d-flex justify-content-end">
                            <a href="message-offers.php?offer_id=<?= $offer['offer_random_id'] ?>" class="btn btn-outline-success">Check Messages</a>
                          </div>
                        </td>
                      </tr>
                    <?php endforeach ?>
              ...
              <div class="tab-pane fade pt-3" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                ...
                <table id="table2" class="table table-hover table-striped">
                  ...
                  <tbody>
                    <?php foreach($offersHistory as $offerHistory): ?>
                      <?php
                        $itemUrlFiles2 = explode(',' , $offerHistory['item_url_file']);
                        $itemFirstFile2 = $itemUrlFiles2[0];
                        $itemExt2 = explode('.', $itemFirstFile2);
                        $itemExt2 = end($itemExt2);

                        $offerUrlFiles2 = explode(',' , $offerHistory['offer_url_file']);
                          ...
                          <div class="row">
                            <div class="col-12 col-md-6 mb-3">
                              ...
                              <div class="d-flex gap-3">
                                ...
                                <div>
                                  <p class="m-0">
                                    <?= $offerHistory['item_title'] ?>
                                  </p>
                                  <p class="m-0 small-text text-muted">
                                    Status:
                                    <?php if($offerHistory['item_status'] == 'available'): ?>
                                      <span class="text-success">
                                        <?= $offerHistory['item_status'] ?>
                                      </span>
                                    <?php else: ?>
                                        <?= $offerHistory['item_status'] ?>
                                    <?php endif ?>
                                  ...
                                  <p class="smaller-text text-muted">
                                    <?= date("M d, Y", strtotime($offerHistory['item_created_at'])) ?>
                                  </p>
                                  <div>
                                    <button class="btn btn-sm btn-light border me-1 mb-2 forPopup w-100"
                                    value="<?= $offerHistory['item_random_id'] ?>"
                                    data-bs-toggle="modal" data-bs-target="#itemModalView">
                                      View
                                    </button>
                                  </div>
                            ...
                            <div class="col-12 col-md-6 mb-3">
                              ...
                              <div class="d-flex gap-3">
                                ...
                                <div>
                                  ...
                                  <p class="m-0 small-text text-muted">
                                    Status:
                                    <?php if($offerHistory['offer_status'] == 'available'): ?>
                                      <span class="text-success">
                                        <?= $offerHistory['offer_status'] ?>
                                      </span>
                                    <?php else: ?>
                                        <?= $offerHistory['offer_status'] ?>
                                    <?php endif ?>
                                  ...
                                  <p class="smaller-text text-muted">
                                    <?= date("M d, Y", strtotime($offerHistory['offer_created_at'])) ?>
                                  </p>
                                  <div>
                                    <button class="btn btn-sm btn-light border me-1 mb-2 forViewOfferModal w-100"
                                    value="<?= $offerHistory['offer_random_id'] ?>"
                                    data-bs-toggle="modal" data-bs-target="#offerModalView">
                                      View
                                    </button>
                                  </div>
